...
func (uq *UserQuery) QueryCredentials() *CredentialQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, user.CredentialsTable, user.CredentialsPrimaryKey...),
		)
...
func (uq *UserQuery) loadCredentials(ctx context.Context, query *CredentialQuery, nodes []*User, init func(*User), assign func(*User, *Credential)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.CredentialsTable)
		s.Join(joinT).On(s.C(credential.FieldID), joinT.C(user.CredentialsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.CredentialsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.CredentialsPrimaryKey[0]))
