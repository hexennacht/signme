...
const (
	Authentication_SignIn_FullMethodName  = "/v1.auth.Authentication/SignIn"
	Authentication_SignUp_FullMethodName  = "/v1.auth.Authentication/SignUp"
	Authentication_SignOut_FullMethodName = "/v1.auth.Authentication/SignOut"
)
...
func (c *authenticationClient) SignIn(ctx context.Context, in *SignInRequest, opts ...grpc.CallOption) (*SignInResponse, error) {
	...
	err := c.cc.Invoke(ctx, Authentication_SignIn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationClient) SignOut(ctx context.Context, in *SignOutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Authentication_SignOut_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthenticationServer) SignOut(context.Context, *SignOutRequest) (*emptypb.Empty, error) {
...
var Authentication_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.auth.Authentication",
